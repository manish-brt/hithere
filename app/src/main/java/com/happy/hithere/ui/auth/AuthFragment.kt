...
import com.happy.hithere.databinding.FragmentAuthBinding
...
//        activity?.let { navController = Navigation.findNavController(it, R.id.authFragNavHost) }

        navController = _binding?.let { Navigation.findNavController(it.root.findViewById(R.id.authFragNavHost)) }
